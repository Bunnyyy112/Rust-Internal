...
#define RunmeeleName L"Fast Bow"
...
#define Omniname L"OmniSprint"
#define Spinbot L"Spinbot"
#define fakey L"Fakelag"
#define Playerfov L"Playerfov"
#define unlimitedjumpey L"unlimitedjump"
#define girr L"Girrafe"
...
HRESULT __stdcall PresentHook(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	if (d3dfirst)
	{
		...
		menu->addItem(RunmeeleName, &impl::Runmeele, group);
		...
		menu->addItem(Omniname, &impl::Omnisprint, group);
		menu->addItem(Spinbot, &impl::Antiaim, group);
		menu->addItem(fakey, &impl::fakelag, group);
		menu->addItem(unlimitedjumpey, &impl::Unlimitedjump, group);
		menu->addItem(Playerfov, &impl::playerfov, group);
		menu->addItem(girr, &impl::girrafe, group);
