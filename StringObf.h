...
#define pr(s) (syn::Obfuscation::String::ObfuscatedString<sizeof(s), __COUNTER__>(s, std::make_index_sequence<sizeof(s)>()).Decrypt())
#define OBFUSCATE_STR_TEA(s) OBFUSCATE_STR(s)
